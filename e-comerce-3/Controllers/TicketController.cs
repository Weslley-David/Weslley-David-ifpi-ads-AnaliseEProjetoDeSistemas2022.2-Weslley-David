...
namespace e_comerce_3.Controllers
{
    public class TicketController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("code,id,value,confirmation,RequestId")] Ticket ticket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("code,id,value,confirmation,RequestId")] Ticket ticket)
        {
            if (id != ticket.id)
            {
                return NotFound();
